...
# https://docs.djangoproject.com/ko/3.2/topics/migrations/

# 절대 상단에서 from shop.models import Category 를 하지 마히고
...
def create_dummy_category(apps, schema_editor):
    ...
    Category.objects.create(name="dummy") # 여기의 pk = 1 될것이다.
